...
const DEFAULT_ITEMS: AccordionGalleryItem[] = [
  { image: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=900&q=80', label: 'My Vidyon (EdTech AI)', link: '#' },
...
export const AccordionGallery: React.FC<AccordionGalleryProps> = ({
  ...
  const handleKeyDown = (i: number, e: React.KeyboardEvent) => {
    if (e.key === 'ArrowRight' || e.key === 'ArrowDown') {
      ...
      setActive(prev);
      if (onItemSelect) onItemSelect(items[prev], prev);
    }
  };
