...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, rgba(14, 26, 56, 0.9) 0%, rgba(56, 189, 248, 0.25) 100%)';
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  title = 'CEO • Founder @ UNAI TECH',
  handle = 'nehemiah_ai',
  status = 'Online • Engineering Intelligence',
  contactText = 'Connect',
  showUserInfo = true,
  onContactClick
}) => {
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      '--behind-glow-color': behindGlowColor ?? 'rgba(56, 189, 248, 0.67)',
