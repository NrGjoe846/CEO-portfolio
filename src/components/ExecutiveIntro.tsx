...
export const ExecutiveIntro: React.FC<ExecutiveIntroProps> = ({ onOpenAdvisorWithPrompt }) => {
  ...
  return (
    <div className="relative w-full">
      ...
      <section
        id="about"
        className="relative w-full pt-[clamp(3.5rem,8vh,6rem)] pb-[clamp(3.5rem,8vh,6rem)] bg-[#ea431b] border-b border-white/15 text-white"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-5 flex flex-col gap-6">
              ...
              <div className="relative mt-2">
                <div className="relative overflow-hidden rounded-2xl bg-black/20 border-2 border-white/20 shadow-2xl group">
                  <img
                  ...
                  />
                  <div className="absolute top-4 right-4 bg-black/80 text-white px-3.5 py-1.5 rounded-md border border-white/30 shadow-lg backdrop-blur-xs">
                    <p className="eyebrow m-0 text-[10px] tracking-widest font-black text-amber-300">
                      CEO &bull; UNAI TECH
                    </p>
                  </div>
                  <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/90 via-black/60 to-transparent p-5 text-white">
                    <p className="eyebrow text-xs tracking-widest text-amber-300 font-bold">CORE MAXIM</p>
                ...
                {/* Floating Pill */}
                <div className="absolute -bottom-4 -left-3 bg-black/90 text-white border-2 border-white/20 p-3 rounded-xl shadow-xl flex items-center gap-3">
                  <div className="w-9 h-9 rounded-full bg-[#ea431b] text-white flex items-center justify-center font-black text-xs shadow-[0_0_12px_rgba(234,67,27,0.8)]">
                    AI
                  </div>
                  <div>
                    <p className="eyebrow text-[9px] text-zinc-400 font-bold">FOCUS</p>
            ...
            <div className="lg:col-span-7 flex flex-col gap-6 lg:pl-4">
              <div>
                <span className="eyebrow text-xs font-black text-amber-300 tracking-widest block mb-2">
              ...
              <div className="p-5 rounded-2xl bg-black/20 border border-white/20 backdrop-blur-xs">
                <p className="eyebrow text-xs text-white/75 font-bold mb-2">
              ...
              <div className="space-y-4 text-base sm:text-lg text-white/90 font-medium leading-relaxed">
                <p>{ABOUT_ME_DATA.journeyText}</p>
                <p>{ABOUT_ME_DATA.currentWork}</p>
                <p className="font-bold text-white bg-black/30 p-4 rounded-xl border border-white/20 shadow-2xs backdrop-blur-xs">
              ...
              <div className="pt-2 flex items-center gap-4">
                <button
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white text-[#ea431b] text-xs font-black uppercase tracking-wider hover:bg-black hover:text-white transition-colors cursor-pointer shadow-md"
                >
      ...
      <section
        id="leadership"
        className="relative w-full pt-[clamp(3.5rem,8vh,6rem)] pb-[clamp(3.5rem,8vh,6rem)] bg-[#d83d16] border-b border-white/15 text-white"
      ...
      >
        <div className="relative z-10 mx-auto max-w-[112rem] px-[max(1.5rem,7vw)]">
          ...
          <div className="mt-8">
            <h3 className="eyebrow text-xs font-black text-amber-300 tracking-widest uppercase mb-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5">
              {LEADERSHIP_PHILOSOPHY.coreResponsibilities.map((item, idx) => (
                <div
                  key={idx}
                  className="flex items-center gap-3 p-4 rounded-xl bg-black/25 border border-white/15 shadow-2xs hover:border-white/40 transition-all backdrop-blur-xs"
                >
                  <span className="w-6 h-6 rounded-full bg-white text-[#ea431b] text-xs font-black flex items-center justify-center shrink-0">
                    {idx + 1}
                  </span>
          ...
          <div className="mt-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
              {LEADERSHIP_PHILOSOPHY.principles.map((pr, idx) => (
                <div
                  key={idx}
                  className="p-5 rounded-2xl bg-black/30 border border-white/20 shadow-md hover:border-white/50 hover:bg-black/40 transition-all flex flex-col justify-between backdrop-blur-xs"
                >
                  <div>
                    ...
                    <span className="eyebrow text-[10px] text-white/60 font-bold block mb-1">
                      PRINCIPLE 0{idx + 1}
                    </span>
        ...
        <div className="relative z-10 mx-auto max-w-[112rem] px-[max(1.5rem,7vw)]">
          <div className="max-w-4xl mx-auto text-center mb-10">
            ...
            <h2 className="display m-0 text-white text-[clamp(2.2rem,4.5vw,4.5rem)] tracking-[-0.04em] leading-tight">
              ...
              <span className="text-amber-300">Build Software Around Intelligence.</span>
            </h2>
          </div>

          {/* Comparison Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            <div className="p-6 sm:p-8 rounded-2xl bg-black/30 border border-white/20 shadow-md flex flex-col justify-between backdrop-blur-xs">
              <div>
                <span className="eyebrow text-xs font-black text-white/60 tracking-wider block mb-2">
                  LEGACY PARADIGM
                </span>
              ...
              <div className="mt-6 pt-4 border-t border-white/15 text-xs font-bold text-white/60">
                Rigid logic &bull; Fixed branching &bull; Zero contextual reasoning
              </div>
            </div>

            <div className="p-6 sm:p-8 rounded-2xl bg-white text-black shadow-xl flex flex-col justify-between">
              <div>
                <span className="eyebrow text-xs font-black text-[#ea431b] tracking-wider block mb-2">
                  AI-NATIVE PARADIGM
                </span>
                <h3 className="display text-xl font-black text-[#0a0403] mb-3">
                  AI-Native Systems
                </h3>
                <p className="body-copy text-base text-[#140805] font-bold leading-relaxed">
                  {WHAT_I_BELIEVE.traditionalVsNative.aiNative}
                </p>
              </div>
              <div className="mt-6 pt-4 border-t border-zinc-200 text-xs font-extrabold text-[#ea431b]">
          ...
          <div className="mt-10 max-w-4xl mx-auto p-6 rounded-2xl bg-[#0a0403] text-white border-2 border-white/20 text-center shadow-2xl">
            <span className="eyebrow text-[10px] text-amber-400 tracking-widest font-black uppercase block mb-2">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 display text-lg sm:text-2xl font-black text-white">
              ...
              <span className="text-[#ea431b]">&rarr;</span>
              <span>Architecture</span>
              <span className="text-[#ea431b]">&rarr;</span>
              <span>Software</span>
              <span className="text-[#ea431b]">&rarr;</span>
              <span className="text-amber-300">Autonomous Operations</span>
            </div>
      ...
      <section
        id="vision"
        className="relative w-full pt-[clamp(3.5rem,8vh,6rem)] pb-[clamp(3.5rem,8vh,6rem)] bg-[#c7310e] text-white"
        aria-label="My Vision"
      >
        <div className="relative z-10 mx-auto max-w-[112rem] px-[max(1.5rem,7vw)]">
          <div className="text-center max-w-3xl mx-auto mb-10">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-black/30 text-white text-xs font-black tracking-widest uppercase mb-3 border border-white/20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            {MY_VISION_DATA.pillars.map((pil, idx) => (
              <div
                key={idx}
                className="p-5 rounded-2xl bg-black/25 border border-white/20 shadow-md hover:border-white/50 hover:bg-black/35 transition-all flex flex-col justify-between backdrop-blur-xs"
              >
                <div>
                  <div className="w-10 h-10 rounded-xl bg-white/15 text-white flex items-center justify-center mb-3">
          ...
          {/* Blockquote Maxim */}
          <div className="mt-10 max-w-3xl mx-auto p-6 rounded-2xl bg-white text-black border-2 border-white text-center shadow-2xl">
            <span className="eyebrow text-xs text-zinc-600 font-bold block mb-1">
              THE NORTH STAR
            </span>
            <p className="display text-xl sm:text-2xl font-black text-[#ea431b]">
